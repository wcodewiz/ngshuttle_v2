...
const ChangePassword = ({ show }) => {
    ...
    return <Account success={success} error={response_error} formPath={"account/login"} show={show} btnText={"Login"} showError={displayError} rule={rule} heading={"Login"} HeadIcon={AiFillLock} >
